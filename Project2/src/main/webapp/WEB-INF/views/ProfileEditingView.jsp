...
<head>
    ...
    <link rel ="stylesheet" href="<%=request.getContextPath() %>/resources/css/ProfileEditingView.css">
        ...
        <div id = "warp">
            ...
            <div id ="body">
                <div id = "center">
                    <section id ="box">
                        <div id = "box_header">
                            <h1 class = "header_title">편집할 프로필을 선택해주세요</h1>
                        </div>
                        <ul id ="profiles">
                            <li class = "profile">
                        ...
                        <div id ="box_footer">
                            <button id = "footer_btn">완료</button>
                        </div>
                    </div>
                </div>
            </div>
